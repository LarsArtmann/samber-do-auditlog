...
The user said "READ ALL *_/2026-07-_ files!" — which I interpreted as exactly the 4 files matching `2026-07-*`. But there are 20 additional `docs/status/2026-06-*` files that are older and potentially staler. Some contain open questions and unresolved action items.
