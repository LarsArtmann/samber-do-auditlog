...
- [Export Formats](/guides/export-formats/) — export the filtered slice in any format
- [Dependency Tracking](/guides/dependency-tracking/) — the data being filtered
- [API Reference](/api-reference/) — `ReportFiltered` and `Filtered` signatures
