...
- [Dependency Tracking](/guides/dependency-tracking/) — how services and scopes are identified
- [go-health](https://github.com/larsartmann/go-health) — Kubernetes health probes built on this integration
- [Live Dashboard](/guides/live-dashboard/) — see health events appear as they run
- [API Reference](/api-reference/) — `RecordHealthCheck*` signatures in full
