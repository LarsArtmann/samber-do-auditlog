...
- [Export Formats](/guides/export-formats/) — render the graph as Mermaid, DOT, D2, or an interactive HTML DAG
- [Filtered Reports](/guides/filtered-reports/) — slice the graph by scope or service type
- [Live Dashboard](/guides/live-dashboard/) — watch dependencies resolve in real time
- [Health Checks](/guides/health-checks/) — the other half of the service record
