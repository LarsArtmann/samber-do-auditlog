...
- [Installation](/getting-started/installation/) — requirements and the `GOEXPERIMENT=jsonv2` flag
- [Export Formats](/guides/export-formats/) — every format with examples
- [Live Dashboard](/guides/live-dashboard/) — watch these events stream in real time
- [API Reference](/api-reference/) — every method on Plugin and Report
