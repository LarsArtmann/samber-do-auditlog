# do-auditlog — Audit-Log Plugin for samber/do v2

Source: https://do-auditlog.lars.software
...
| `extracted/tokens.json`           | Design tokens: 14 colors, 1 fonts, 20 headings, 0 CTAs                                                                                                     |
...
- **Colors**: #C4B89E (surface-light), #14110D (surface-dark), #E8A838 (accent), #F5EAD6 (bg-light), #1C1915 (surface-dark), #4A4030 (neutral), #9C9078 (neutral), #000000 (bg-dark), #F0BC5C (surface-light), #FFFFFF (bg-light)
- **Fonts**: -apple-system (400,500,600,700)
