...
```
live/hub.go         — Hub: facade over sse.Broadcaster[sse.Event] with subscriber buffer (128 events), SignalComplete, OnEvent callback, Shutdown/Health pass-through. Defines sseEventType constant.
